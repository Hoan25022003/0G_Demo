  ...
  return (
    <div className="flex flex-col main-content item-center gap-y-10">
      <div className="flex flex-col lg:flex-row gap-y-2 sm:gap-y-3 lg:gap-x-6 xl:gap-x-10">
        ...
        <div className=" z-50 flex flex-col gap-y-5 lg:flex-[4] items-center lg:items-start">
          <h1 className="font-medium text-[80px] sm:text-[90px] lg:text-[100px] leading-[1] opacity-90 stats-text-shadow capitalize ">
            0G SALE
          </h1>
