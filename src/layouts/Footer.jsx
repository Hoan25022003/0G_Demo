const Footer = () => (
  <footer className="bg-gradient-to-t from-[#FFAF90] via-[#FFAF90] to-secondColor">
    <div className="max-w-screen-xl px-10 mx-auto">
            ...
            <form className="flex flex-row items-center w-full mx-auto gap-x-1 lg:gap-x-2">
              <div className="w-full">
                <input
                  type="email"
                  id="email"
                  className="block w-full px-3 py-1 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 md:px-5 md:py-4"
              ...
              <button
                type="submit"
                className="px-3 py-1 text-sm font-medium text-center text-white rounded-full bg-primaryColor md:px-5 md:py-4"
              >
                Subscribe
              </button>
            </form>
      ...
      <hr className="mt-3 border-white sm:mx-auto md:mt-6" />
